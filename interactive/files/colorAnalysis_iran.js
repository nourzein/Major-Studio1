...
//read files
fs.readFile("./codebeautify_iran.json", "utf8", (err, data) => {
...
function getDominantColor(imageObj) {
  const fileName = "./downloads_iran/" + imageObj.image.replace(/^.*\//, ""); //replace everything before the / with nothing
